  ...
  Widget build(BuildContext context) => CustomTheme(
    child: SimpleDialog(
      title: Column(
        ...
        children: <Widget>[
          text("Cari Kode Negara", textColor: KelolakuGlobalColor.dark70, fontSize: 16.0, fontFamily: "Semibold"),
          SizedBox(height: 8),
          TextField(
        ...
        children: <Widget>[
          ...
          Expanded(
            ...
            child: Row(
              ...
              children: <Widget>[
                Expanded(child: text(e.toLongString(), fontSize: textSizeMedium, textColor: KelolakuGlobalColor.dark40)),
                text(e.dialCode, fontSize: textSizeMedium, textColor: KelolakuGlobalColor.dark40, fontFamily: "Semibold"),
              ],
            ),
          ),
        ],
