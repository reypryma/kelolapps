...
import 'package:kelolapps/utils/countrypicker/selection_dialog.dart';
      ...
      _widget = TextButton(
        ...
        child: Flex(
          ...
          children: <Widget>[
            ...
            Flexible(
              fit: widget.alignLeft ? FlexFit.tight : FlexFit.loose,
              child: text(selectedItem!.toCountryCodeString(), textColor: KelolakuGlobalColor.dark, fontSize: 16.0),
            ),
          ],
        ),
      );
