...
import 'package:kelolapps/view/screens/sheets/share_to_social.dart';
              ...
              SliverAppBar(
                                        ...
                                        Container(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                                          ...
                                                          Padding(
                                                            ...
                                                            child: SizedBox(
                                                              ...
                                                              child: FloatingActionButton(
                                                                ...
                                                                child: const Icon(Icons.close, color: KelolakuGlobalColor.dark),
                                                              ),
                                                            ),
                                                          ),
                                                          Padding(
                                                            ...
                                                            child: Container(
                                                              ...
                                                              child: Column(
                                                                ...
                                                                children: <Widget>[
                                                                  Text(AppString.shareTo, style: heading3.copyWith(
                                                                  ...
                                                                  Container(
                                                                    ...
                                                                    decoration: BoxDecoration(borderRadius: radius(16), color: KelolakuGlobalColor.lightSmoke),
                                                                    child: Row(
                                                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                                      children: [
                                                                        Text(
                                              ...
                                              child: Text('Bagikan', style: heading3.copyWith(color: KelolakuGlobalColor.ocean))),
                                            ],
                                          ),
                                        ).expand(),
                                      ],
                ...
                flexibleSpace: FlexibleSpaceBar(
                  ...
                  background: Container(
                    ...
                    margin: const EdgeInsets.only(top: Dimensions.VERTICAL_SIZE_16),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.start,
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          margin: const EdgeInsets.all(Dimensions.MARGIN_SIZE_GRID_8),
